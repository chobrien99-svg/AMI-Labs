...
const SYSTEM_PROMPT = [
  ...
  "publications, GitHub activity, French corporate/IP filings, and site monitoring, and write a concise,",
  "analytical briefing that helps a reader understand what it all MEANS — connecting signals across sources.",
  "",
  "HARD RULES:",
